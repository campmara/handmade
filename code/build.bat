...
:: Compile x64.
del *.pdb > NUL 2> NUL
call cl %HM_WARNINGS% %HM_DEFINES% %HM_OPTIMIZATIONS% ..\code\handmade.cpp -Fmhandmade.map -LD /link -incremental:no -opt:ref /PDB:handmade_%HM_TIMESTAMP%.pdb /EXPORT:GameGetSoundSamples /EXPORT:GameUpdateAndRender
